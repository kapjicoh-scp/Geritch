...
***************************************************************************** */
        ...
        function initSliders() {
            ...
            if (document.querySelector(".body-bar-slider")) new core(".body-bar-slider", {
                modules: [ Pagination, EffectFade, Autoplay, Lazy ],
                effect: "fade",
                autoplay: {
                    delay: 5e3,
                ...
                on: {
                    init: function() {
                        const controll = document.querySelectorAll(".body-bar-slider__controll .swiper-pagination-bullet");
                        controll.forEach(((el, index) => {
                            let num;
                            if (index < 10) num = `0`;
                            el.innerHTML = `${num}${index + 1}`;
                    ...
                    breakpoint: function(swiper, info) {
                        !info.autoHeight ? document.querySelector(".body-bar-slider__swiper").style.height = "auto" : "";
                        swiper.updateSize();
                    }
                }
            });
